...
class JavaPaintUI extends JFrame {
  ...
  public void updateCanvas() {
    ...
    if (tool == 1) {
      ...
      g2d.fillOval(
          currentX - ((int) value / 2), currentY - ((int) value / 2), (int) value, (int) value);
    } else if (tool == 2) {
  ...
  private Color getColor() {
    ...
    else if (color == 2) c = Color.gray;
    else if (color == 3) c = Color.white;
    else if (color == 4) c = Color.red;
    else if (color == 5) c = Color.green;
    else if (color == 6) c = Color.blue;
  ...
  private void initComponents() {
    ...
    jRadioButton9.addActionListener(
        new ActionListener() {
    ...
    jRadioButton10.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent evt) {
    ...
    canvasLabel.addMouseMotionListener(
    ...
    */
    ...
    jRadioButton5.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent evt) {
    ...
    jRadioButton8.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent evt) {
                ...
                jPanel3Layout
                    ...
                    .addGroup(
                        jPanel3Layout
                            .createParallelGroup(GroupLayout.Alignment.LEADING)
                            .addComponent(
                                jRadioButton5, GroupLayout.DEFAULT_SIZE, 55, Short.MAX_VALUE)
                            .addComponent(
                                jRadioButton6,
                                GroupLayout.DEFAULT_SIZE,
                                GroupLayout.DEFAULT_SIZE,
  ...
  private void jButton2ActionPerformed(ActionEvent evt) {
    ...
    JOptionPane.showMessageDialog(
        null,
        "JavaPaint is a simple java based painting application." + "  Nick R 5/22/2011",
        "About",
